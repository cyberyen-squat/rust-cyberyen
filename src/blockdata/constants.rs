...
pub const DIFFCHANGE_TIMESPAN: u32 = 60 * 240;
...
fn bitcoin_genesis_tx() -> Transaction {
    ...
    let in_script = script::Builder::new().push_scriptint(486604799)
                                          .push_scriptint(4)
                                          .push_slice("The Dark Side of the Moon 2022".as_bytes())
                                          .into_script();
    ret.input.push(TxIn {
...
mod test {
    ...
    fn bitcoin_genesis_first_transaction() {
        ...
        assert_eq!(serialize(&gen.input[0].script_sig),
                   Vec::from_hex("2604ffff001d01041e546865204461726b2053696465206f6620746865204d6f6f6e2032303232").unwrap());
        ...
        assert_eq!(gen.output[0].value, 1000000 * COIN_VALUE);
        assert_eq!(gen.lock_time, 0);

        assert_eq!(format!("{:x}", gen.wtxid()),
                   "7055a6ae72bdfdaafaac2619d61684e037f477870d70951bd3bf6964d36bc405".to_string());
    }
    ...
    fn bitcoin_genesis_full_block() {
        ...
        assert_eq!(format!("{:x}", gen.header.merkle_root),
                   "7055a6ae72bdfdaafaac2619d61684e037f477870d70951bd3bf6964d36bc405".to_string());
        assert_eq!(gen.header.time, 1659708882);
        assert_eq!(gen.header.bits, 0x1e0ffff0);
        assert_eq!(gen.header.nonce, 2000096520);
        assert_eq!(format!("{:x}", gen.header.block_hash()),
                   "34458c96bb547193fa90b2f2599056684b0083d8a2996f2025943eb545031d29".to_string());
    }
    ...
    fn testnet_genesis_full_block() {
        ...
        assert_eq!(format!("{:x}", gen.header.merkle_root),
                  "7055a6ae72bdfdaafaac2619d61684e037f477870d70951bd3bf6964d36bc405".to_string());
        assert_eq!(gen.header.time, 1744018230);
        assert_eq!(gen.header.bits, 0x1e0ffff0);
        assert_eq!(gen.header.nonce, 245836);
        assert_eq!(format!("{:x}", gen.header.block_hash()),
                   "1f847ccbaa8055eb1af82aef862aeb53d1d4d3ff81a8bcc514f6c071a4e6e580".to_string());
    }
